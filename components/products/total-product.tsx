        ...
        <div className="bg-slate-600 rounded-md p-2 relative">
            ...
            <div>
                ...
                <div className="flex items-center justify-start gap-2">
                    <div className="text-[35px] text-neutral-400 ">{product && product.length <10 && product.length>0 ? `0${product.length}`:product.length}</div>
                    <div className="text-[12px] ">
                        <div className="mb-[-2px] text-green-500">+ {totalProductThisWeek && totalProductThisWeek.length <10  && totalProductThisWeek.length>0? `0${totalProductThisWeek.length}`:totalProductThisWeek.length}</div>
