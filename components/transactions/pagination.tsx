        ...
        <div
                ...
                >
                    <button 
                        ...
                        onClick={()=>{
                            router.push(`/dashboards/transaction?search=${search}&payment=${payment}&status=${status}&startDate=${startDate}&endDate=${endDate}&page=${page -1}&per_page=10`)
                        }}
                    ...
                    <div className="flex items-center justify-between gap-2">
                        {
                            pagin && pagin.map((item)=>{
                                return (
                                    <div 
                                         onClick={()=>{
                                            router.push(`/dashboards/transaction?search=${search}&payment=${payment}&status=${status}&startDate=${startDate}&endDate=${endDate}&page=${item +1}&per_page=10`)
                                         }}
                                         key={item} 
