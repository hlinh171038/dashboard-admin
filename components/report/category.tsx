...
const CategoryReport:React.FC<CategoryRadioProps> = ({
    id,
    customerValue,
    categorys = [],
    setCustomerValue,
  ...
  const [openSort,setOpenSort] = useState(false)
    const [text,setText] = useState(customerValue.length >0 ? customerValue :`--- choose your ${id} ---`)
    ...
    return (
        <div className="  w-full flex flex-col items-start justify-start gap-[1%] relative h-[70px] min-w-[30%] ">
                   
                   <div className='relative w-full'>
                            <div className="text-neutral-200 text-[15px] capitalize "></div>
                              <div className="  text-[14px] text-neutral-200 w-[300px]">
                                ...
                                >
                                  <div className={cn("duration-300 transition-all focus:bg-neutral-100 focus:text-slate-900 capitalize w-full",
