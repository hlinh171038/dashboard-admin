...
const CommentItemLike:React.FC<CommentItemProps> = ({
    userName,
    userImage,
    createdAt,
    id
        ...
        <div className="flex items-start justify-between ">
                <div className="flex items-center justify-start gap-2">
                    ...
                    <div className="flex flex-col gap-0.5">
                        <div>{userName} liked your commment.</div>
                ...
                <div>
                    <Popover>
                        ...
                        >   
                            ...
                            <button onClick={()=>handleGoToEmail(id)} className="flex items-center justify-start gap-1 py-0.5 px-2 bg-slate  cursor-pointer hover:bg-slate-100 rounded-md text-[14px]">
...
export default CommentItemLike